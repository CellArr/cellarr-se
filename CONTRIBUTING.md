...
Welcome to `cellarr-se` contributor's guide.
...
If you experience bugs or general issues with `cellarr-se`, please have a look
...
You can help improve `cellarr-se` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`cellarr-se` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `cellarr-se`'s files. While this mechanism can
...
```
conda create -n cellarr-se python=3 six virtualenv pytest pytest-cov
conda activate cellarr-se
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/cellarr-se.git
   cd cellarr-se
   ```
...
5. Install [pre-commit]:
   ...
   `cellarr-se` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/cellarr-se
[issue tracker]: https://github.com/<USERNAME>/cellarr-se/issues
