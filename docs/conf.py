...
module_dir = os.path.join(__location__, "../src/cellarr_se")
try:
...
try:
    from cellarr_se import __version__ as version
except ImportError:
    version = ""
...
htmlhelp_basename = "cellarr-se-doc"
...
latex_documents = [
    ("index", "user_guide.tex", "cellarr-se Documentation", "chanjd", "manual")
]
